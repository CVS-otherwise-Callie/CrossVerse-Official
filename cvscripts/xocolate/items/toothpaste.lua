...
function mod:UpdateToothpasteDamage(player)
    local itemCount = player:GetCollectibleNum(CollectibleType.COLLECTIBLE_TOOTHPASTE)
...
function mod:UpdateToothpasteTearcolor(player)
    if player:GetCollectibleNum(CollectibleType.COLLECTIBLE_TOOTHPASTE) >= 1 then
